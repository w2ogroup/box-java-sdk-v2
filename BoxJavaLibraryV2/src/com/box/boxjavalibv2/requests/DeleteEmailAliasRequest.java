...
public class DeleteEmailAliasRequest extends DefaultBoxRequest {
     ...
     *             exception
     */
    public DeleteEmailAliasRequest(final IBoxConfig config, final ObjectMapper objectMapper, final String userId, final String emailId,
        BoxDefaultRequestObject requestObject) throws BoxRestException {
        super(config, objectMapper, getUri(userId, emailId), RestMethod.DELETE, requestObject);
    }
