...
@JsonSubTypes({@Type(value = BoxFile.class, name = "file"), @Type(value = BoxFolder.class, name = "folder"),@Type(value = BoxWebLink.class, name = "web_link"),
               @Type(value = BoxCollaboration.class, name = "collaboration"), @Type(value = BoxComment.class, name = "comment"),
               @Type(value = BoxEmailAlias.class, name = "email_alias"), @Type(value = BoxFileVersion.class, name = "file_version"),
               @Type(value = BoxUser.class, name = "user"), @Type(value = BoxServerError.class, name = "error")})
